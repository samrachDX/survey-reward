...
const { getSurveyQuestions, logSurveyResponseToSheets } = require('../services/sheetsService');
...
router.post('/submit', async (req, res) => {
  try {
    ...
    // Store survey response in MongoDB
    ...
    // Save RewardToken to MongoDB so /redeem can validate it
    ...
    // Log survey answers to Google Sheets (async, non-blocking)
    logSurveyResponseToSheets({ answers, token, timestamp })
      .catch(err => logger.error('Failed to log survey response to Sheets:', err));
